...
const BookCard = ({ title, author, image, extra, button = "true" }) => {
		...
		>
			<div className="h-full w-full">
				<div className="relative w-full">
					<img
						src={image}
						className="mb-3 h-96 w-full rounded-xl 3xl:h-full 3xl:w-full"
						alt=""
					/>
					<button
				...
				<div className="flex items-center justify-between md:flex-col md:items-start lg:flex-row lg:justify-between xl:flex-col 2xl:items-start 3xl:flex-row 3xl:items-center 3xl:justify-between">
					<div className="">
						<Dropdown
							button={
								<p className="mb-2 text-sm font-bold text-brand-500 dark:text-white hover:cursor-pointer">
									Book Details
								</p>
							}
									...
									<button className="flex w-full items-center">
										<div className="ml-2 flex h-full w-full flex-col justify-center rounded-lg px-1 text-sm">
											<p className="mb-1 text-left text-base font-bold text-gray-900 dark:text-white">
												New Update: Horizon UI Dashboard
												PRO
											</p>
